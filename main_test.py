...
from librairy import Book, Library, Client
...
class TestLibrary(unittest.TestCase):
    ...
    def test_check_out_book(self):
        ...
        self.library.check_out_book("Unknown book")
        self.assertEqual(len(self.library.books), 2)
    ...
    def test_check_in_book(self):
        ...
        self.library.check_in_book("Unknown book")
        self.assertEqual(len(self.library.books), 2)
...
class TestClient(unittest.TestCase):
    ...
    def test_check_out_book(self):
        ...
        self.assertTrue(self.book2.is_checked_out)
        self.client.check_out_book(self.library, "Unknown book")
    ...
    def test_check_in_book(self):
        ...
        self.assertFalse(self.book1.is_checked_out)
        self.client.check_in_book(self.library, "Unknown book")
